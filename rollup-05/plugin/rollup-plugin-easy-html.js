...
const easyHtml = ({ entries = {}, exclude = new Set(), externals, favicon, fileName: htmlFileName, inject = true, meta, minify: minifyOptions, onlinePath, template, title, ...options }) => ({
    name: 'html2',
    buildStart({ plugins }) {
        const deprecated = {
            preload: 'entries',
